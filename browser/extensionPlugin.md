...
```json
{
  "name": "budgetManager", // 插件名
  "version": "1.0", // 插件version版本
  "manifest_version": 2,
  "description": "hel1o world 插件", // 插件简介
  "icons": {
    // 插件图标
    "128": "img/logo.png",
    "48": "img/logo.png",
  ...
  "browser_action": {
    ...
    "default_popup": "popup.html" //点击弹窗popup
  },
  // 插件权限
  "permissions": ["storage"],
  "options_page": "options.html" //插件配置页面
}
```
...
```json
{
  ...
  "manifest_version": 2, // 插件的名称
  "name": "demo", // 插件的版本
  "version": "1.0.0", // 插件描述
  "description": "简单的Chrome扩展demo", // 图标，一般偷懒全部用一个尺寸的也没问题
  "icons": {
    "16": "img/icon.png",
    "48": "img/icon.png",
    "128": "img/icon.png"
  ...
  "options_page": "options.html", // Chrome40以后的插件配置页写法，如果2个都写，新版Chrome只认后面这一个
  "options_ui": {
    "page": "options.html", // 添加一些默认的样式，推荐使用
    "chrome_style": true
  }, // 向地址栏注册一个关键字以提供搜索建议，只能设置一个关键字
  "omnibox": { "keyword": "go" }, // 默认语言
  "default_locale": "zh_CN", // devtools页面入口，注意只能指向一个HTML文件，不能是JS文件
